...
// DepositKeys is a free data retrieval call binding the contract method 0x9883455a.
//
// Solidity: function depositKeys( uint256) constant returns(bytes32)
func (_Contract *ContractCaller) DepositKeys(opts *bind.CallOpts, arg0 *big.Int) ([32]byte, error) {
	var (
		ret0 = new([32]byte)
	)
	out := ret0
	err := _Contract.contract.Call(opts, out, "depositKeys", arg0)
	return *ret0, err
}
...
//
// Solidity: function depositKeys( uint256) constant returns(bytes32)
func (_Contract *ContractSession) DepositKeys(arg0 *big.Int) ([32]byte, error) {
	return _Contract.Contract.DepositKeys(&_Contract.CallOpts, arg0)
}

// DepositKeys is a free data retrieval call binding the contract method 0x9883455a.
//
// Solidity: function depositKeys( uint256) constant returns(bytes32)
func (_Contract *ContractCallerSession) DepositKeys(arg0 *big.Int) ([32]byte, error) {
	return _Contract.Contract.DepositKeys(&_Contract.CallOpts, arg0)
}
...
//
// Solidity: function toBytes(_id uint256, _addr address, _tokenName string, _value uint256) constant returns(bytes32)
func (_Contract *ContractCaller) ToBytes(opts *bind.CallOpts, _id *big.Int, _addr common.Address, _tokenName string, _value *big.Int) ([32]byte, error) {
	var (
		ret0 = new([32]byte)
	)
	out := ret0
...
//
// Solidity: function toBytes(_id uint256, _addr address, _tokenName string, _value uint256) constant returns(bytes32)
func (_Contract *ContractSession) ToBytes(_id *big.Int, _addr common.Address, _tokenName string, _value *big.Int) ([32]byte, error) {
...
//
// Solidity: function toBytes(_id uint256, _addr address, _tokenName string, _value uint256) constant returns(bytes32)
func (_Contract *ContractCallerSession) ToBytes(_id *big.Int, _addr common.Address, _tokenName string, _value *big.Int) ([32]byte, error) {
	return _Contract.Contract.ToBytes(&_Contract.CallOpts, _id, _addr, _tokenName, _value)
}
...
// CrossChainTransactionCoin is a paid mutator transaction binding the contract method 0x248b30d7.
//
// Solidity: function crossChainTransactionCoin(_addr string) returns()
func (_Contract *ContractTransactor) CrossChainTransactionCoin(opts *bind.TransactOpts, _addr string) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "crossChainTransactionCoin", _addr)
}

// CrossChainTransactionCoin is a paid mutator transaction binding the contract method 0x248b30d7.
//
// Solidity: function crossChainTransactionCoin(_addr string) returns()
func (_Contract *ContractSession) CrossChainTransactionCoin(_addr string) (*types.Transaction, error) {
	return _Contract.Contract.CrossChainTransactionCoin(&_Contract.TransactOpts, _addr)
}

// CrossChainTransactionCoin is a paid mutator transaction binding the contract method 0x248b30d7.
//
// Solidity: function crossChainTransactionCoin(_addr string) returns()
func (_Contract *ContractTransactorSession) CrossChainTransactionCoin(_addr string) (*types.Transaction, error) {
	return _Contract.Contract.CrossChainTransactionCoin(&_Contract.TransactOpts, _addr)
}

// CrossChainTransactionToken is a paid mutator transaction binding the contract method 0x29ccc298.
//
// Solidity: function crossChainTransactionToken(token address, _tokenName string, _addr string, _value uint256) returns()
func (_Contract *ContractTransactor) CrossChainTransactionToken(opts *bind.TransactOpts, token common.Address, _tokenName string, _addr string, _value *big.Int) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "crossChainTransactionToken", token, _tokenName, _addr, _value)
}

// CrossChainTransactionToken is a paid mutator transaction binding the contract method 0x29ccc298.
//
// Solidity: function crossChainTransactionToken(token address, _tokenName string, _addr string, _value uint256) returns()
func (_Contract *ContractSession) CrossChainTransactionToken(token common.Address, _tokenName string, _addr string, _value *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.CrossChainTransactionToken(&_Contract.TransactOpts, token, _tokenName, _addr, _value)
}

// CrossChainTransactionToken is a paid mutator transaction binding the contract method 0x29ccc298.
//
// Solidity: function crossChainTransactionToken(token address, _tokenName string, _addr string, _value uint256) returns()
func (_Contract *ContractTransactorSession) CrossChainTransactionToken(token common.Address, _tokenName string, _addr string, _value *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.CrossChainTransactionToken(&_Contract.TransactOpts, token, _tokenName, _addr, _value)
}
