...
func (app *CarnotApp) initFromGenesisState(ctx sdk.Context, genesisState GenesisState) []abci.ValidatorUpdate {
...
// custom logic for carnot initialization
func (app *CarnotApp) initChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
